...
<div class="container">
    <h2>List Employee</h2>
    @if($username == 'dirut' || $username == 'dirops1' || 
    $username == 'dirops2' || $username == 'dirops3' || $username == 'dirops4' || 
    $username == 'dirops5')
    @else
    <br>
    ...
    @endif
    <!--    <a class="btn btn-primary open-addModal1" id="addEmpDW" data-toggle="modal" href="#addModal1">
            <span class="glyphicon glyphicon-plus-sign"></span> Add Employee DW
        </a>-->
                    ...
                    <table id="empTable" class="table table-responsive table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($emp->joined_date != null && $emp->joined_date != '1970-01-01 00:00:00')
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addModal" aria-hidden="true">
    <div class="modal-dialog modal-xtra-large-no-margin">
        <div class="modal-content">
            ...
            <form onsubmit="return validateAddEmployee()" method="post" action="{{ route('hrd.addEmp') }}">
                <div class="modal-body">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <?php $employment_status = \DB::table("employment_status")->whereIn("id", [1,2])->get(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <?php $employee = \DB::table("employee")->where("termination_id", 0)->where("location_id", $project->id)->whereIn("emp_status", [1,2,5])->orderBy("employee_id", "ASC")->get(); ?>
